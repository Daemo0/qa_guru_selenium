...
@pytest.mark.parametrize("invalid_email", [
    ...
    "john.doe@com",          # Нет доменной зоны верхнего уровня - TODO: обратите особое внимание #done
    "john@missing-dot",      # Нет точки в домене - TODO: обратите особое внимание #done
...
@pytest.mark.parametrize("security_payload", [
    "<script>alert('xss')</script>",                 # Базовый XSS скрипт - TODO: нашли и исправили ошибку? X
    "1' OR '1'='1",                                  # Базовая SQL-инъекция
    ":):):):))))::;)",                               # Суррогатные пары (Эмодзи)
    "<div>HTML injection</div>"                      # Теги верстки - нашли ошибку? - TODO: нашли и исправили ошибку? X
])
