...
class AutomationPracticeFormTestSuite:
    ...
    def test_form_positive02(self):
        ...
        self.automation_practice_form.fill_in_form(self.tmp_file_name, "Anfisa","Maximova", "anf@maximov.com", "Female","0987654321",("2002", "2", "17"),("Biology", "Arts"), ("Sports"), "443000, г. Самара, ул. Пушкина, д 1", "Haryana",  "Karnal")
        self.automation_practice_form.assert_form(self.tmp_file_name, "Anfisa","Maximova", "anf@maximov.com", "Female","0987654321",("2002", "2", "17"),("Biology", "Arts"), ("Sports"), "443000, г. Самара, ул. Пушкина, д 1", "Haryana",  "Karnal")
